...
| [`block-destructive-commands`](https://github.com/open-coder-ai/chock-catalog/blob/main/docs/block-destructive-commands/README.md) | 0.0.4 | enforces | Best-effort guard against destructive commands: rm -rf targeting absolute, home, or root-adjacen... |
...
| [`block-no-verify`](https://github.com/open-coder-ai/chock-catalog/blob/main/docs/block-no-verify/README.md) | 0.0.2 | enforces | Best-effort guard against bypassing git hooks via git commit/push --no-verify or -n |
